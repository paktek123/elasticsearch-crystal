  ...
  module Transport
    module Transport
      ...
      module Base
        ...
        getter   :hosts, :options, :connections, :counter, :last_request_at, :protocol
        property :serializer, :sniffer, :logger, :tracer,
        ...
        #
        def initialize(arguments={} of Symbol => Char, &block)
          @state_mutex = Mutex.new

          @hosts       = arguments[:hosts]   || [] of String
          @options     = arguments[:options] || {} of Char => Char
          @options[:http] ||= {} of Char => Char
          @options[:retry_on_status] ||= [] of String
        ...
        #
        def get_connection(options={} of Char => Char)
        ...
        # @api private
        #
        def __rebuild_connections(arguments={} of Symbol => Char)
        ...
        def __build_connections
          Connections::Collection.new \
            :connections => hosts.map { |host|
              ...
              __build_connection(host, (options[:transport_options] || {} of Char => Char), @block)
            },
        ...
        # @api private
        #
        def __convert_to_json(o=nil, options={} of Char => Char)
        ...
        #
        def perform_request(method, path, params={} of Char => Char, body=nil, &block)
