  ...
  module API
    module Indices
      module Actions
        ...
        #
        def get_aliases(arguments={} of Symbol => String)
          valid_params = [ :timeout, :local ]

          method = "GET"
          path   = Utils.__pathify Utils.__listify(arguments[:index].as(String)), "_aliases", Utils.__listify(arguments[:name].as(String))
